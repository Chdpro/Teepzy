...
export class ContactService {
  ...
  inviteViaSms(invitation): Observable<any> {
    ...
    return this.http.post(local_url + url, invitation, httpOptionsJson);
  }
  ...
  addProduct(product): Observable<any> {
    ...
    return this.http.post(local_url + url, JSON.stringify(product), httpOptionsJson);
  }
  ...
  changeAccount(change?: any) {
    ...
    return this.http.post(local_url + url, JSON.stringify(change), httpOptionsJson);
  }
  ...
  spam(sign): Observable<any> {
    ...
    return this.http.post(local_url + url, JSON.stringify(sign), httpOptionsJson);
  }
