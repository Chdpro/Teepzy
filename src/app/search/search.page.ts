...
export class SearchPage implements OnInit {
  ...
  testVideos = ["https://teepzy-api-myapp.onrender.com/43107192329982330.mp4"];
        ...
        (res) => {
          ...
          this.usersNotInCircles.forEach((e) => {
            ...
            this.subscription = this.contactService
              ...
              .subscribe((res) => {
                if (res["status"] == 201) {
                  this.checkAvailability(this.listTeepzrsToInvite, e["_id"])
                    ? null
  ...
  searchOnMatches() {
    ...
    this.subscription = this.contactService
      .SearchInCircleOnMatch(this.search)
      .subscribe(
        (res) => {
          //   console.log(res);
          this.loading = false;
